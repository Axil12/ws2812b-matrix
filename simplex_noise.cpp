...
#include <Arduino.h>  // int32_t/uint8_t
...
float SimplexNoise::noise2dOctaves(float x, float y, int octaves, float persistence) {
  float max_amp = 0.0f;
  float amp = 1.0f;
  float noise = 0.0f;
  float freq = 1.0f;
...
float SimplexNoise::noise3dOctaves(float x, float y, float z, int octaves, float persistence) {
  float max_amp = 0.0f;
  float amp = 1.0f;
  float noise = 0.0f;
  float freq = 1.0f;
