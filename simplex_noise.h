...
public:
    ...
    static float noise2dOctaves(float x, float y, int octaves, float persistence);
    static float noise3dOctaves(float x, float y, float z, int octaves, float persistence);
